...
subplot(2,1,2);            %Plot spectrum of frequency modulated signal
plot(f, real(fftphi), 'LineWidth', 1.7);
xlabel('---> Frequency(Hz)');    ylabel('---> \phi_{FM}(f)');
title('1(b) Frequency spectrum of \phi_{FM}(t)');
